...
public interface DataAccessStrategy extends ReadingDataAccessStrategy, RelationResolver {
	 ...
	 * @param objectToSave the object to be stored. Must not be {@code null}.
	 * @param domainType the type of the object. Must not be {@code null}.
	 ...
	 * @since 2.4
	 */
	<T> @Nullable Object insert(T objectToSave, Class<T> domainType, Identifier identifier, IdValueSource idValueSource);

	/**
	 * Inserts the data of multiple entities.
	 *
	 * @param <T> the type of the object.
	 * @param insertSubjects the subjects to be inserted, where each subject contains the object and its identifier. Must
	 *          not be {@code null}.
	 * @param domainType the type of the object. Must not be {@code null}.
	 * @param idValueSource the {@link IdValueSource} for the insert.
	 ...
	 *
	 * @param objectToSave the object to save. Must not be {@code null}.
	 * @param domainType the type of the object to save. Must not be {@code null}.
	 * @param <T> the type of the object to save.
	 * @return whether the update actually updated a row.
	 */
	<T> boolean update(T objectToSave, Class<T> domainType);
	 ...
	 * @param objectToSave the object to save. Must not be {@code null}.
	 * @param domainType the type of the object to save. Must not be {@code null}.
	 * @param previousVersion The previous version assigned to the object being saved.
	 * @param <T> the type of the object to save.
	 * @return whether the update actually updated a row.
	 ...
	 * @since 2.0
	 */
	<T> boolean updateWithVersion(T objectToSave, Class<T> domainType, Number previousVersion);

	/**
	 * Upserts the data of a single entity (insert if row for id does not exist, update if it exists). The object must
	 * have an assigned identifier.
	 * <p>
	 * The used dialect is required to support single-statement upsert.
	 *
	 * @param objectToSave the object to upsert. Must not be {@code null}. Must have an id set.
	 * @param domainType the type of the object. Must not be {@code null}.
	 * @param <T> the type of the object.
	...
	/**
	 * Deletes all entities reachable via {@literal propertyPath} from the object identified by {@literal rootId}.
	 *
	...
	/**
	 * Deletes all entities reachable via {@literal propertyPath} from the objects identified by {@literal rootIds}.
	 *
	...
	/**
	 * Deletes all entities reachable via {@literal propertyPath} from any object.
	 *
	 * @param propertyPath Leading from the root object to the entities to be deleted. Must not be {@code null}.
	 */
